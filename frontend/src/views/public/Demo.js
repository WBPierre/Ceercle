                                ...
                                <Grid item sx={{mx: 5}}>
                                    <List>
                                        <ListItem>
                                            ...
                                            <ListItemText style={{color:'#999595'}} primaryTypographyProps={{fontSize:25}} primary={t('demo:check_1')} />
                                        </ListItem>
                                        <ListItem>
                                            <ListItemIcon>
                                                <Check sx={{color:"#2F5597"}}/>
                                            </ListItemIcon>
                                            <ListItemText style={{color:'#999595'}} primaryTypographyProps={{fontSize:25}} primary={t('demo:check_3')} />
                                        </ListItem>
                                    </List>
                                </Grid>
                            </Grid>
